...
export default function ActivityDetailContainer() {
    ...
    if (loading) return <p className= "text-center mt-10 text-base">Cargando detalles...</p>
    if (error) return <p className= "text-center text-red-500 mt-10 text-base">{error}</p>;
